...
public class LlenarFormulario{
	...
	public void Login() {
		...
		String resultadoObtenido = Driver.getCurrentUrl();
     	...
     	WebDriverWait myWey = new WebDriverWait(Driver, 15);
		...
		//button[contains(text(),'Nuevo prestamo MiPYMES')]
        ...
        /*WebDriverWait time02 = new WebDriverWait(Driver, 15);
      	time02.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@id='cargo']")));
        WebElement Cargo = Driver.findElement(By.xpath("//input[@id='cargo']"));
        Cargo.sendKeys("Analista de sistemas");*/
        
        
    	//Driver.findElement(By.xpath("//button[normalize-space()='Datos Laborales']")).click();
        
       /* WebDriverWait time02 = new WebDriverWait(Driver, 15);
      	time02.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[normalize-space()='Datos Laborales']")));
        Driver.findElement(By.xpath("//button[normalize-space()='Datos Laborales']")).click();*/
        
        

       /* WebDriverWait time02 = new WebDriverWait(Driver, 20);
      	time02.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[contains(text(),'Datos Laborales')]")));
      
        
        WebDriverWait time03 = new WebDriverWait(Driver, 20);
      	time03.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@id='cargo']")));
        WebElement Cargo = Driver.findElement(By.xpath("//input[@id='cargo']"));
        Cargo.sendKeys("Analista de Sistemas");*/
        
        //Select solicitante = new Select(Driver.findElement(By.id("//select[@id='estadocivil-select']")));
		//solicitante.deselectByVisibleText("CASADO");
